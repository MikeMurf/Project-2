...
//   var countryData = covidData.filter(countryobject => 
//     countryobject.country_name == country);
//   // var population = countryData[3]
//   // Use d3 to select the panel with id of `#sample-metadata`
//   var panel = d3.select("#sample-metadata");
//   // Use `.html("") to clear any existing country
//   panel.html("");
...
// Set the country to Australia to build the initial plots
const ausData = "Australia";
getCovidData(ausData);
